...
# Instrumentation key
instr_key = 'InstrumentationKey=481d1339-1cba-4e83-bf01-9c85203731f3'
...
redis_server = '127.0.0.1' #os.environ['REDIS'] #'127.0.0.1' #os.environ['REDIS']
...
def index():
    ...
    if request.method == 'GET':
        ...
        if request.form['vote'] == 'reset':
            ...
            logger.info('New ' + animal_type + ' vote')
